...
image = cv2.imread("image/twice.jpg", cv2.IMREAD_COLOR)
...
if facesCnt > 0:
    ...
    cv2.imwrite("result/my_image_mosaic2.jpg", image)

    cv2.imshow("mosaic_image", cv2.imread("result/my_image_mosaic2.jpg", cv2.IMREAD_COLOR))
